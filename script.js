...
const switchInput = document.getElementById('checkbox_input');
const duration = document.getElementById('month');
...
function handleRangeInput(e) {
    ...
    rangeInput.style.background = `linear-gradient(to right,        hsl(174, 77%, 80%) 0%, hsl(174, 77%, 80%) ${(inputValue * 100) / 80}%, hsl(224, 65%, 95%) 50%, hsl(224, 65%, 95%) 100%)`;
    plan(inputValue);
}
